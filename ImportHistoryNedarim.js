...
sql.query(str,async function (error, results, fields){
    ...
    axios.get(`https://matara.pro/nedarimplus/Reports/Manage3.aspx?Action=GetHistoryJson&MosadId=1000347&ApiPassword=ka639&Lastid=${Lastid}`).then((response) => {
        ...
        Lastid = response.data[max -1].TransactionId
